...
| গ | g |
| ঘ | gh |
| ঙ | ng, ngf ([বিস্তারিত নিচে](/docs/#-অনসবর-এব-ঙ-লখ)) |
| চ | c |
| ছ | ch |
| জ | j |
| ঝ | jh |
...
| ক্ষ | kf, kkh, ksf |
| ৎ | t/ |
| ং | ng, ng; ([বিস্তারিত নিচে](/docs/#-অনসবর-এব-ঙ-লখ)) |
| ঃ | x |
| ঁ | / |
...
1. ng \= ং এবং ng; \= ং যেমন:  
   বাংলা \= bangla
   অঙ্ক \= ongko
   অংক \= ong;k    
3. ngf \= ঙ। তবে ng এর পর স্বর এলেও ঙ হবে। যেমন:  
   বাঙালি \= bangali  
4. সেই সাথে যুক্তবর্ণে ng দিয়ে ঙ হবে। যেমন:  
   শঙ্খ \= shongkh  
   1. তবে উপরের আচরণের ব্যতিক্রম প্রয়োজন হলে ng এর পরে পৃথায়ক বসাতে হবে। যেমন:  
      সংখ্যা \= song;khza
...
<table border="0.5" cellspacing="0" cellpadding="4">
  ...
  <tr>
    <td>ngf<br>ng{স্বরবর্ণ}<br>ng (যুক্তবর্ণে)</td>
    <td>ঙ</td>
    <td>baengf<br>rongo<br>ranga<br>rangga<br>ongk<br>ong;k</td>
    <td>ব্যাঙ<br>রঙ<br>রাঙা<br>রাঙ্গা<br>অঙ্ক<br>অংক</td>
  </tr>
  <tr>
    <td>c</td>
    <td>চ</td>
...
3. টাকা, রুপি এবং ডলার চিহ্নের ম্যাপিং,  
4. গুণ, ভাগ এবং অসমান চিহ্নের ম্যাপিং,  
