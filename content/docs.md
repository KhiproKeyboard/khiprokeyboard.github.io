...
3. ng এর পর স্বর এলে ঙ হবে। যেমন:  
   বাঙালি \= bangali  
4. তবে যুক্তবর্ণে ng দিয়ে ঙ হবে। যেমন:  
   শঙ্খ \= shongkh  
...
<table border="0.5" cellspacing="0" cellpadding="4">
  ...
  <tr>
    <td>xx</td>
    <td> ্{ZWNJ}</td>
    <td colspan="2">হসন্ত সাথে ZWNJ. যুক্তবর্ণ গঠন করবে না এমন হসন্ত। শব্দের মাঝে হসন্ত দেখাতে, udxxdiin = উদ্‌দীন</td>
  </tr>
  <tr>
    <td>``</td>
    <td>[ZWNJ]</td>
    <td colspan="2">হসন্তের যুক্তবর্ণ গঠন রোধ করে—যা ঠিক এর উপরের ঘরেই আলোচিত হয়েছে। এছাড়া স্বচ্ছ স্টাইলের কারচিহ্ন লিখতে এটি ব্যবহৃত হয়।</td>
  </tr>
  <tr>
    <td>~~</td>
    <td>[ZWJ]</td>
