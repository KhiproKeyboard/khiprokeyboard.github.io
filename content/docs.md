...
<table border="0.5" cellspacing="0" cellpadding="4">
  ...
  <tr>
    <td>``</td>
    <td>[ZWNJ]</td>
    <td colspan="2">হসন্তের যুক্তবর্ণ গঠন রোধ করে—যা ঠিক এর উপরের<br>ঘরেই আলোচিত হয়েছে। এছাড়া স্বচ্ছ স্টাইলের কারচিহ্ন<br>লিখতে এটি ব্যবহৃত হয়।</td>
  </tr>
  <tr>
    <td>~~</td>
    <td>[ZWJ]</td>
    <td colspan="2">র‍্য লিখতে এবং যুক্তবর্ণের সংক্ষিপ্ত গ্লিফ লিখতে এটি<br>ব্যবহৃত হয়।</td>
  </tr>
</table>
