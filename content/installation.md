...
NMS Kontho সফটওয়্যারের জন্য কমিউনিটির তৈরি একটি ক্ষিপ্র-ভিত্তিক লেআউট রয়েছে। প্রথমে NMS Kontho কিবোর্ড ইনস্টল করে নিন। এরপর নিচের লিংক থেকে ক্ষিপ্র লেআউটটি ডাউনলোড করে Kontho কিবোর্ডে ইমপোর্ট করে কিবোর্ড রিস্টার্ট করুন। তারপর লেআউট সিলেকশন প্যানেল থেকে Khipro (Custom) লেআউটটি সিলেক্ট করে নিন।
