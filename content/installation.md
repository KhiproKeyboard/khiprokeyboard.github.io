...
লিনাক্সে স্টেবল রিলিজ ছাড়াও প্রি-রিলিজ় ভার্শন ইনস্টল করে ট্রাই করতে পারবেন। সেটা করার জন্যও নিচের কমান্ডটি রান করে `Install stable release from the main branch? (Y/n): ` জিজ্ঞেস করা হলে `n` দিন। এবং ব্রাঞ্চের নাম জিজ্ঞেস করলে যেই ব্রাঞ্চ থেকে ইনস্টল করবেন সেই ব্রাঞ্চের নাম দিন। এই উপায়ে টেস্টিং ব্রাঞ্চে কিংবা অন্য কোনো ব্রাঞ্চ কোনো ঝামেলা ছাড়াই ইনস্টল করা যাবে।
...
1. কোডপত্রের জনপ্রিয় বর্ণ কিবোর্ডের এর নতুন দুটি ভার্শন Borno Native ও Borno Drops-এ ক্ষিপ্র লেআউট বিল্ট-ইন রয়েছে।
2. NMS Kontho অ্যাপ্লিকেশনের মাধ্যমে।

## বর্ণ কিবোর্ডের মাধ্যমে

কোডপত্রের জনপ্রিয় কিবোর্ড বর্ণতে ক্ষিপ্র লেআউট বিল্ট-ইন থাকছে।
...
হেলিবোর্ড একটি ওপেনসোর্স আন্ড্রয়েড কিবোর্ড। আমাদের কমিউনিটির হাত ধরে ক্ষিপ্র লেআউট এই কিবোর্ডে যুক্ত হয়েছে। হেলিবোর্ডের `3.6-beta1` ও পরবর্তী সকল Beta ও Stable রিলিজ থেকে ক্ষিপ্র লেয়াউট ব্যবহার করা যাবে। নিচের লিংক থেকে হেলিবোর্ড ডাউনলোড করতে পারবেন।
...
হেলিবোর্ডের রিলিজে দুটি সমস্যা রয়েছে:  
১. শব্দের মাঝে ইডিট করা যায়না, শেষে চলে যায়। এটা হেলিবোর্ড এর কম্বাইনার-এর সমস্যা।  
...
২. ইশ্বর চিহ্নের ম্যাপিংয়ে ডটের পরিবর্তে দাঁড়ির ব্যবহার করা হয়েছে। অর্থাৎ `।ff` \= `৺`
